<?php /*a:2:{s:70:"/Applications/MAMP/htdocs/blog/application/admin/view/article/add.html";i:1541917920;s:72:"/Applications/MAMP/htdocs/blog/application/admin/view/common/header.html";i:1542077104;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-content">
        <div class="layui-row">
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" enctype="multipart/form-data" action="<?php echo url('article/add'); ?>" Method='post'>
                    <div class="layui-form-item">
                        <label class="layui-form-label">文章标题</label>
                        <div class="layui-input-block">
                            <input type="text" name="title" style="width: 60%;" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
